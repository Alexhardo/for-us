...
document.write("<h1>" + "Chuck-Out" + "<h1>");
...
document.write("<button class='action'>" + "Open Dialog" + "</button>");
...
for (var i = 0; i < movies.length; i++) {
    ...
    document.write('<br>');
    document.write('<img src="' + movies[i].img + '">' + '<br>');
    document.write("<b>" + "Rating: " + "</b>" + movies[i].Rating + "<br>");
    document.write('<br>');
    document.write('<br>');
...
for (var i = 0; i < books.length; i++) {
    ...
    document.write('<br>');
    document.write('<img src="' + books[i].img + '">' + '<br>');
    document.write("<b>" + "Rating: " + "</b>" + books[i].Rating + "<br>");
    document.write('<br>');
    document.write('<br>');
...
for (var i = 0; i < audio.length; i++) {
    ...
    document.write('<br>');
    document.write('<img src="' + audio[i].img + '">' + '<br>');
    document.write("<b>" + "Rating: " + "</b>" + audio[i].Rating + "<br>");
    document.write('<br>');
    document.write('<br>');
